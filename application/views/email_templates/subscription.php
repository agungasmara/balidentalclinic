...
$imagesDir = base_url($this->config->item('emailImagesDir') . 'voucher/');
?>
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px;line-height:0px;"><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
  <img class="center  autowidth  fullwidth" align="center" border="0" src="<?php echo $imagesDir . 'subscription-voucher.jpg'; ?>" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 500px" width="500">
<!--[if mso]></td></tr></table><![endif]-->
</div>
...
If you need teeth whitening services, don't hesitate to use this offer ! Just bring this voucher or email to our clinic and you will get special 20% off for teeth whitening.</p>
<p style="text-align: center">
